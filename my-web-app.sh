...
az webapp create --name $WEBAPP_NAME --resource-group $RESOURCE_GROUP_NAME  --plan $APPSERVICE_PLAN_NAME --deployment-source-url $DEPLOYMENT_SOURCE --runtime "PHP|8.0"
